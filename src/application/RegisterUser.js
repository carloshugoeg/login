...
export class RegisterUser {
  ...
  async execute(input) {
    ...
    await this.#pendingRegistrations.removeByEmail(email);
    ...
    const saved = await this.#pendingRegistrations.save(pending);
    ...
    try {
      ...
      await this.#pendingRegistrations.removeById(saved.id);
      throw error;
    }
    return saved;
  }
